...
const items = [
  ...
  { id: 2, nav: '/Ajl_portfolio/projects', label: 'Projects', icon: <LucideLayoutGrid className="h-[3vh] w-[3vw]" /> },
  { id: 3, nav: '/Ajl_portfolio/about', label: 'About Me', icon: <CircleUserRound className="h-[3vh] w-[3vw]" /> },
  { id: 4, nav: '/Ajl_portfolio/contact', label: 'Contact', icon: <Mail className="h-[3vh] w-[3vw]" /> },
];
